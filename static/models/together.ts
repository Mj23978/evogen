...
const models: ModelInfo[] = [
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "LlamaRank is a language model specialized for document ranking. LlamaRank achieves performance at least comparable to leading APIs across general document ranking while demonstrating a marked improvement in code search.",
      "config": {
        "stop": [
          "<|eot_id|>"
        ],
  ...
  },
  {
    ...
    "metadata": {
      ...
      "link": "https://huggingface.co/black-forest-labs/FLUX.1-schnell",
      "description": "FLUX1.1 [pro] provides six times faster generation than its predecessor FLUX.1 [pro] while also improving image quality, prompt adherence, and diversity.",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "The LLaMA-2 model is a large language model trained on a mixture of data sources.",
      "config": {
        "stop": [
          "</s>"
        ],
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Mixture of Agents (MoA) is a novel approach that leverages the collective strengths of multiple LLMs to enhance performance, achieving state-of-the-art results",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Llama-3-Typhoon-v1.5-8B-Instruct is an instruct Thai 🇹🇭 large language model with 8 billion parameters, and it is based on Llama3-8B.",
      "config": {
        "stop": [
          "<|eot_id|>"
        ],
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Llama-3-Typhoon-v1.5X-70B-instruct is a 70 billion parameter instruct  model designed for the Thai 🇹🇭 language. It demonstrates  competitive performance with GPT-4-0612, and is optimized for application use cases,  Retrieval-Augmented Generation (RAG), constrained generation, and reasoning tasks.",
      "config": {
        "stop": [
          "<|eot_id|>"
        ],
  ...
  },
  {
    ...
    "metadata": {
      ...
      "link": "https://huggingface.co/black-forest-labs/FLUX.1-schnell",
      "description": "The best of FLUX.1, offering state-of-the-art performance image generation with top of the line prompt following, visual quality, image detail and output diversity.",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "FLUX.1 Redux [dev] is an adapter for all FLUX.1 base models for image variation generation. Given an input image, FLUX.1 Redux can reproduce the image with slight variation, allowing to refine a given image. It naturally integrates into more complex workflows unlocking image restyling.",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "FLUX.1 Depth [dev] is a 12 billion parameter rectified flow transformer capable of generating an image based on a text description while following the structure of a given input image.",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "FLUX.1 Canny [dev] is 12 billion parameter rectified flow transformer capable of generating an image based on a text description while following the structure of a given input image.",
      "config": {
        "stop": [],
        "chat_template": null,
        "bos_token": null,
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Qwen2.5-VL is the latest version of the vision language models based on Qwen2 in the Qwen model family.",
      "config": {
        "stop": [
          "<|im_end|>",
          "<|endoftext|>"
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Llama3.1-Typhoon2-70B-instruct is a instruct Thai 🇹🇭   large language model with 70 billion parameters, and it is based on Llama3.1-70B.",
      "config": {
        "stop": [
          "<|eot_id|>"
        ],
  ...
  },
  {
    ...
    "metadata": {
      ...
      "description": "Qwen2-VL is the latest version of the vision language models based on Qwen2 in the Qwen model family.",
      "config": {
        "stop": [
          "<|im_end|>",
          "<|endoftext|>"
